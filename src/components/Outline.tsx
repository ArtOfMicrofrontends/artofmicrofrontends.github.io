      ...
      <ol>
        <li>
          ...
          <p>
            ...
            thus for the whole book. The crucial learning is to show that micro frontends are the natural next step for
            a truly decoupled, decentralized, and distributed web. The role of modern standards such as web components
            is discussed, as well as the analogy to microservices.
          </p>
        </li>
        <li>
          <h4>Common Challenges and Pitfalls</h4>
          <p>
            Today, micro frontends are among the most difficult pieces of technology. The challenges are many and cannot
      ...
      <ol start={5}>
        <li>
          ...
          <p>
            ...
            much more fragmented for micro frontends. Nevertheless, we can construct a phase space with 3 dimensions to
            ...
            compile-time micro frontends, which is an effective learning tool to see how complexity can be shifted to
            any stage (development-time to compile-time to server-runtime to client-runtime).
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            globally aggregated sitemap allows linking without much maintenance effort. Using iframe sources instead of
            top-level navigation screen fragments can be reused.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            style allows to dynamically stitch a view together from various sources. It allows horizontal micro
            frontends without requiring any shared repository at all. The chapter goes into all the details of what and
        ...
        <li>
          <h4>Siteless UIs</h4>
          <p>
            Similar to serverless functions siteless UIs provide a way of writing micro frontends without having to take
            ...
            runtime basis for a set of micro frontends that can be independently developed, deployed, and maintained to
      ...
      <ol start={12}>
        <li>
          ...
          <p>
            ...
            and ends with the setup of the different teams. Ultimately, every organization adopting micro frontends will
        ...
        <li>
          ...
          <p>
            ...
            more outside of the inner circle. In the extreme case users may submit their own micro frontends that run
